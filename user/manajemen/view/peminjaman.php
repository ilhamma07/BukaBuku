...
<br>
<div class="panel">
	<a href="index.php?m=view&p=tambah_peminjaman" class="btn-a">Tambah Data</a>
	<br>
	<br>
			...
			if(mysqli_num_rows($sql) > 0) {
				while ($dataPeminjaman = mysqli_fetch_array($sql)) {
					...
					echo "	<tr class='tr'>
								...
								<td>
									<a href='index.php?m=view&&p=edit_peminjaman&kd_peminjaman=$dataPeminjaman[kd_peminjaman]' class='btn-edit'><span class='glyphicon glyphicon-edit'></span></a>
									<a href='index.php?m=modul&&p=hapus_peminjaman&kd_peminjaman=$dataPeminjaman[kd_peminjaman]' class='btn-hapus' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\"><span class='glyphicon glyphicon-trash'></span></a>
								</td>
							<tr>
					";
				}
